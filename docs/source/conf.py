...
# flight_delay_prediction documentation build
...
from flight_delay_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "flight_delay_prediction"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "flight_delay_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "flight_delay_prediction.tex",
        "flight_delay_prediction Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "flight_delay_prediction",
        "Project flight_delay_prediction codebase.",
        "Data-Science",
    )
]
